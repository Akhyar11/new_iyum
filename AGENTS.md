...
- Workspace ID: `c1e88780-8eb0-449e-8e7e-2904760c27e5`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/c1e88780-8eb0-449e-8e7e-2904760c27e5.
...
2. `npx ngodingpakeai connect --workspace c1e88780-8eb0-449e-8e7e-2904760c27e5 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/c1e88780-8eb0-449e-8e7e-2904760c27e5. Only pass on links the CLI actually printed — never assemble one from an id yourself.
